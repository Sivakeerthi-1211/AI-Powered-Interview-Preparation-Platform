...
def create_app(config_name=None):
    ...
    # Determine storage URI - use Redis if available, otherwise memory
    storage_uri = "memory://"
    if hasattr(Config, 'REDIS_URL') and Config.REDIS_URL:
        ...
        try:
            ...
            print("[App] Using Redis for rate limiting (localhost)")
        except:
            print("[App] Redis not available, using in-memory rate limiting")
            storage_uri = "memory://"
